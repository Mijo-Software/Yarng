...
namespace Yarng
{
	public partial class ProbabilityTableForm : Form
	{
		...
		private void ProbabilityTableForm_Load(object sender, EventArgs e)
		{
			...
			columnHeaderLength.TextAlign = HorizontalAlignment.Center;
			columnHeaderLength.Width = 45;
			columnHeaderPercent.Text = "Percent";
			columnHeaderPercent.TextAlign = HorizontalAlignment.Center;
		  ...
		  listViewCharacters.Columns.AddRange(new ColumnHeader[] { columnHeaderCharacter, columnHeaderType, columnHeaderLength, columnHeaderPercent });
			...
			listViewCharacters.Items.AddRange(new ListViewItem[]
			{
				itemCharacterA, itemCharacterB, itemCharacterC, itemCharacterD, itemCharacterE,
				itemCharacterF, itemCharacterG, itemCharacterH, itemCharacterI, itemCharacterJ,
				itemCharacterK, itemCharacterL, itemCharacterM, itemCharacterN, itemCharacterO,
				itemCharacterP, itemCharacterQ, itemCharacterR, itemCharacterS, itemCharacterT,
				itemCharacterU, itemCharacterV, itemCharacterW, itemCharacterX, itemCharacterY,
				itemCharacterZ
			});
		}
