// Yarng.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CYarngApp, CWinApp)
	//{{AFX_MSG_MAP(CYarngApp)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CYarngApp object

CYarngApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CYarngApp initialization

BOOL CYarngApp::InitInstance()
{
	if (!AfxSocketInit())
	{
